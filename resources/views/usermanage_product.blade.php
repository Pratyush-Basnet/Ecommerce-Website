...
@section('container')
    ...
    <a href="{{url('userdashboard/product')}}">
        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{route('userdashboard.manage_product_process')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    <label for="brand" class="control-label mb-1"> Price</label>
                                    <input id="brand" value="{{$price}}" name="price" type="text" class="form-control" aria-required="true" aria-invalid="false" required>
                                </div>
